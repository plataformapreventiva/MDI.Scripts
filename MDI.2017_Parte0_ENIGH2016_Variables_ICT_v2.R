...
### 01_poblacion2}
# General - Poblacion1
poblacion1 <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/poblacion.dbf", as.is = TRUE)
...
write.csv( poblacion, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_rezeducacion.csv", row.names = FALSE)
write.dbf( poblacion, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_rezeducacion.dbf")

#detach(poblacion)

### 11_privacion_social}
#rm(list=ls())
trabajos <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/trabajos.dbf",
                     as.is = TRUE)
attach(trabajos)
dim(trabajos)
...
write.csv(trabajos2,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_basetrabajadora.csv", row.names = FALSE)
write.dbf(trabajos2,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_basetrabajadora.dbf")

### 18_integracion_poblacion_basetrabajadora}
poblacion1 <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/poblacion.dbf", 
                       as.is = TRUE)
names(poblacion1) <-  tolower(names(poblacion1))
dim(poblacion1)
...
ocupados <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_basetrabajadora.dbf", 
                     as.is = TRUE)
dim(ocupados)
...
write.csv(poblacion,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_poblacion.csv", 
          row.names = FALSE)

write.dbf(poblacion,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_poblacion.dbf")
...
write.csv(poblacion,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_salud.csv", 
          row.names = FALSE)

write.dbf(poblacion,"MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_salud.dbf")
...
trabajos2 <- orderBy(~+folioviv+foliohog+numren, data=trabajos2)
write.csv(trabajos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_prestaciones_laborales.csv", 
          row.names = FALSE)
write.dbf(trabajos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_prestaciones_laborales.dbf")


### 56_ingresos_pension}
ingresos <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/ingresos.dbf",
                     as.is = TRUE)
...
write.csv(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresos_pensiones.csv", 
          row.names = FALSE)
write.dbf(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresos_pensiones.dbf")
...
prestaciones <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_prestaciones_laborales.dbf",
                         as.is = TRUE)
...
rm(prestaciones)
poblacion <- orderBy(~+folioviv+foliohog+numren, data=poblacion)
pensiones <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresos_pensiones.dbf", as.is = TRUE)
...
write.csv(poblacion, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_seguridadsocial.csv", 
          row.names = FALSE)
write.dbf(poblacion, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_seguridadsocial.dbf")

### 89_ic_carencia_vivienda}
#rm(list=ls())
hogares<- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/hogares.dbf",
                   as.is = TRUE)

hogares <- orderBy(~+folioviv, data=hogares)

vivienda <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/viviendas.dbf",
                     as.is = TRUE)
...
write.csv(hogares2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_vivienda.csv",
          row.names = FALSE)
write.dbf(hogares2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_vivienda.dbf")
attach(hogares2)

### 96_hogares}
hogares <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/viviendas.dbf",
                    as.is = TRUE)
...
write.csv(hogares, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_privacionsocial.csv", 
          row.names = FALSE)
write.dbf(hogares, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_privacionsocial.dbf")
#detach(hogares)
...
write.csv(poblacion2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_hogares_menos12a.csv", 
          row.names = FALSE)
write.dbf(poblacion2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_hogares_menos12a.dbf")
#detach(poblacion2)
...
attach(hogares)
write.csv(hogares, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_alimentacion_12a.csv",
          row.names = FALSE)
write.dbf(hogares, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ic_alimentacion_12a.dbf")
...
write.dbf(aguinaldo, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_aguinaldo.dbf")
write.csv(aguinaldo, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_aguinaldo.csv", 
          row.names=FALSE)
detach(trabajos2)
...
write.csv(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente.csv",
          row.names = FALSE)
write.dbf(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente.dbf")
...
nomonetariopersona <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/gastospersona.dbf",
                               as.is = TRUE)
...
nomonetariohogar <- 
  read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/gastoshogar.dbf",
           as.is = TRUE)
...
write.csv(nomonetarioreg2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_nomonetarioreg2.csv", 
          row.names = FALSE)
write.dbf(nomonetarioreg2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_nomonetarioreg2.dbf")

gc()

### 174_ingreso_corriente_total}
library("foreign")
concentrado <- read.dbf("Bases.Datos.Original/ENIGH.2016/Microdatos/concentradohogar.dbf",
                        as.is = TRUE)
...
### ***** ###
ingresos2 <- read.csv("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente.csv",
                      header = TRUE)
...
write.csv(concentrado3, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente_total.csv", 
          row.names = FALSE)
write.dbf(concentrado3, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente_total.dbf")

#### ****** ###

### 175_bienestar_tamaniohogar}
poblacion1 <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_poblacion.dbf",
                       as.is = TRUE)
...
write.csv(poblacion2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_tamhogesc.csv", 
          row.names = FALSE)
write.dbf(poblacion2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_tamhogesc.dbf")
...
### *** Revisar ###
library("foreign")
ingresos <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_ingresocorriente_total.dbf",
                     as.is = TRUE)

poblacion2 <- read.dbf("MDI.Scripts/Datos.Modelo/Tablas_2016/2016_tamhogesc.dbf",
                       as.is = TRUE)
...
write.csv(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_bienestar_ingreso.csv",
          row.names = FALSE)
write.dbf(ingresos2, "MDI.Scripts/Datos.Modelo/Tablas_2016/2016_bienestar_ingreso.dbf")
