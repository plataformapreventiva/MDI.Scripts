...
concentradohogar <- read.dbf("../Bases.Datos.Original/ENIGH.2016/Microdatos/concentradohogar.dbf", 
                       as.is = TRUE)
...
```{r 0_poblacion_jefe}
poblacion <- read.dbf("../Bases.Datos.Original/ENIGH.2016/Microdatos/poblacion.dbf", 
                       as.is = TRUE)
dim(poblacion)
...
```{r 0_viviendas}
viviendas <- read.dbf("../Bases.Datos.Original/ENIGH.2016/Microdatos/viviendas.dbf", 
                       as.is = TRUE)
dim(viviendas)
