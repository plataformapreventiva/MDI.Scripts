...
write.csv(hogares_agr_rur,file="./Datos.Modelo/Tablas/hogares_agr_rur.csv")
```
...
write.csv(hogares_agr_urb,file="./Datos.Modelo/Tablas/hogares_agr_urb.csv")
```
...
save( finalMemb_rur,finalMemb_urb,
     ...
     file = "./Datos.Modelo/mdi_segmentacion.RData")
ls()
gc()
```