...
title: "Anexo 2.3. Cuantiles segmentados y regresion cuantilica para ENIGH"
#thanks: "Agradecimientos..."
author: 
- name: "Juan Carlos Martinez-Ovando"
- affiliation: ITAM
abstract: "Se presenta y comenta el codigo para calcular los cuantiles segmentados del ictpc y estimar los modelos de regresion cuantilica sobre datos ENIGH 2016. La segmentacion mayor es definida por estratos supervisados rural y urbano."
#keywords: "..."
...
Las bases de datos se obtivieron de los procesos previos. Descargamos el objeto de los componentes del modelo:

a) Variables ENIGH-CUIS: `mdi_variables_modelo.RData`

b) Segmentacion: `modelo_segmentacion.RData`
...
Cargamos las lineas de bienestar historicas definidas por CONEVAL. 

El archivo de datos es `coneval_lineas_bienestar.csv`, mientras que el objeto en `R` se nombra `lb_lbm`.
...
### Seleccionamos el periodo del umbral

Para efectos del estudio, se emplean las lineas de bienestr correspondientes a **Junio** de **2017**.
...
write.csv(modelo_seg_rur_tab,file="./Datos.Modelo/Tablas/modelo_seg_rur_tab.csv")
```
...
write.csv(modelo_seg_urb_tab,file="./Datos.Modelo/Tablas/modelo_seg_urb_tab.csv")
```
...
save(modelo_actual_rur,modelo_actual_urb,
     ...
     lb_rur,lb_urb,
     lbm_rur,lbm_urb,
     file = "./Datos.Modelo/mdi_regresion.RData")
ls()
gc()
```
