...
write.csv(hogares_agr_rur,file="MDI.Scripts/Datos.Modelo/Tablas/hogares_agr_rur_ps.csv")
...
write.csv(hogares_agr_urb,file="MDI.Scripts/Datos.Modelo/Tablas/hogares_agr_urb_ps.csv")
...
save(modelo_seg_rur,
     ...
     var_enighcuis_num,
     var_enighcuis_cat,
     file = "MDI.Scripts/Datos.Modelo/modelo_segmentacion_ps.RData")
ls()
gc()