...
path.data <- "../Bases.Datos.Original/ENIGH2016/"
...
ocupados <- read.dbf('Bases4Analysis/2016_basetrabajadora.dbf', 
                     as.is = TRUE)
dim(ocupados)
...
### ***** ###
ingresos2 <- read.csv("C:/Users/jcmo/Google Drive/JCMO.Sedesol.V/Bases4Analysis/2016_ingresocorriente.csv",
                      header = TRUE)
